package art.timestop.serviceapp.api.security;
...
public class SecurityConfig {
	...
	public SecurityFilterChain configure(HttpSecurity http)  throws Exception{
		...
		http.csrf((csrf)-> csrf.ignoringRequestMatchers("/actuator/busrefresh"));
	...
	InMemoryUserDetailsManager userDetailsService(PasswordEncoder passwordEncoder) {
		...
		UserDetails client = User
				.withUsername(environment.getProperty("client.spring.security.user.name"))
				.password(passwordEncoder.encode(environment.getProperty("client.spring.security.user.password")))
				.roles(environment.getProperty("client.spring.security.user.roles"))
				.build();
